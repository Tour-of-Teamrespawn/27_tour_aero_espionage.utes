...
class TOUR_IED_bombDefuse
{
	idd = 314159;
	movingEnable = 0;
	controlsBackground[] = {"Background", "BackgroundHelp", "BackgroundIEDInfo", "Header", "HelpText", "BombInfoHeader", "BombType", "BombSize", "BombMass", "TimeLeftText", "TimeLeftValue", "SequenceText", "Sequence1Bg", "Sequence1Pic", "Sequence2Bg", "Sequence2Pic", "Sequence3Bg", "Sequence3Pic", "Sequence4Bg", "Sequence4Pic", "Sequence5Bg", "Sequence5Pic", "Sequence6Bg", "Sequence6Pic", "Sequence7Bg", "Sequence7Pic", "Sequence8Bg", "Sequence8Pic"};
	objects[] = {};
	...
	class BackgroundHelp : TOUR_IED_RscText
	{
		colorBackground[] = {0, 0, 0, 0.6};
		style = 128;
		x = __EVAL(__posX + 0.05);
		y = __EVAL(__posY + 0.05);
		w = __EVAL(__sizeX / 1.75);
		h = 0.255;
	};
	class Header : TOUR_IED_RscStructuredText
	{
	...
	{
		idc = 2;
		x = __EVAL(__posX + 0.425);
		text = "Cancel";
		action = "closeDialog 314159;";
	};
	class BackgroundIEDInfo : TOUR_IED_RscText
	{
		colorBackground[] = {0, 0, 0, 0.6};
		style = 128;
		x = __EVAL(((__sizeX / 3) * 2) + 0.1);
		y = __EVAL(__posY + 0.05);
		w = __EVAL(__sizeX / 4);
		h = 0.255;
	};
	class BombInfoHeader : TOUR_IED_RscStructuredText
	{
		x = __EVAL(((__sizeX / 3) * 2) + 0.1);
		y = __EVAL(__posY + 0.05);
		w = __EVAL(__sizeX / 3);
	...
	class BombSize: BombInfoHeader
	{
		idc = 1026;
		text = "Size: "; //--- ToDo: Localize;
		x = __EVAL(((__sizeX / 3) * 2) + 0.1);
		y = __EVAL(__posY + 0.17);
		w = __sizeX;
		h = 0.2;
		size = 0.032;
		class Attributes
	...
	class BombMass: BombInfoHeader
	{
		idc = 1027;
		text = "Mass: "; //--- ToDo: Localize;
		x = __EVAL(((__sizeX / 3) * 2) + 0.1);
		y = __EVAL(__posY + 0.24);
		w = __sizeX;
		h = 0.2;
		size = 0.032;
		class Attributes
