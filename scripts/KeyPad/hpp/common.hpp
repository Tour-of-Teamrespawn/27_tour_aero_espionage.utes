...
class TOUR_KP_RscGUIListBox : TOUR_KP_RscListBox 
{
	color[] = {1, 1, 1, 1};
...
class TOUR_KP_RscButton
{
	...
	colorBackgroundActive[] = {0.85, 0.85, 0.85, 1};
	colorFocused[] = {0.75,0.75,0.75,1};
	colorBackgroundFocused[] = {0.85,0.85,0.85,1};
